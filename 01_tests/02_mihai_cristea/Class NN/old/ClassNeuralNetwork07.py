...
#             self.layers[l].dw = 1/batch_dim * np.dot(self.layers[l].dz,self.layers[l-1].a.T) 
             self.layers[l].dw = 1/batch_dim * np.dot(self.layers[l].dz,self.layers[l-1].a.T) + lmbd / (2 * batch_dim) * self.layers[l].w
...
nn.fit(X_train.T, y_train.T, 8, 2000, 0.01,lmbd= 0.01)
